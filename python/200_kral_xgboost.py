...
'''
Example: 
python 200_kral_xgboost.py --config kaggle-fedesoriano-stroke-prediction-dataset.config.json            > log/200_kral_xgboost-kaggle-fedesoriano-stroke-prediction-dataset.log 
python 200_kral_xgboost.py --config kaggle-fedesoriano-stroke-prediction-dataset.config.json --kdims 8  > log/200_kral_xgboost-kaggle-fedesoriano-stroke-prediction-dataset-D08.log 
python 200_kral_xgboost.py --config kaggle-fedesoriano-stroke-prediction-dataset.config.json --kdims 16 > log/200_kral_xgboost-kaggle-fedesoriano-stroke-prediction-dataset-D16.log 
python 200_kral_xgboost.py --config kaggle-fedesoriano-stroke-prediction-dataset.config.json --kdims 24 > log/200_kral_xgboost-kaggle-fedesoriano-stroke-prediction-dataset-D32.log 
python 200_kral_xgboost.py --config kaggle-fedesoriano-stroke-prediction-dataset.config.json --kdims 32 > log/200_kral_xgboost-kaggle-fedesoriano-stroke-prediction-dataset-D32.log 
'''
...
if P_KDIMS:
    ...
    X_train, X_test, Y_train, Y_test = ds.open_dataset(P_DATA_FULL_PATH = v_data_full_path, P_DROP_COLS = P_DROP_COLS, P_SPLIT_LABELS = P_LABELS, P_SUBJECT_COLUMN = P_SUBJECT, P_CONTINUOUS = kg_continuous_features)
...
for label_index in range(len(P_LABELS)):
    ...
    for target_label_value in target_label_values:
        ...
        if P_KDIMS:
            Output_Model_File_Name = "../xgboost" + "/" + P_DATA_FOLDER + "-" + P_DATA_SET + "-" + label + "-" + s_target_label_value + "-D" + str(P_KDIMS) + "."+"xgb"
            Output_Score_File_Name = "../xgboost" + "/" + P_DATA_FOLDER + "-" + P_DATA_SET + "-" + label + "-" + s_target_label_value + "-D" + str(P_KDIMS) + "."+"json"
        else:
            Output_Model_File_Name = "../xgboost" + "/" + P_DATA_FOLDER + "-" + P_DATA_SET + "-" + label + "-" + s_target_label_value + "."+"xgb"
            Output_Score_File_Name = "../xgboost" + "/" + P_DATA_FOLDER + "-" + P_DATA_SET + "-" + label + "-" + s_target_label_value + "."+"json"
